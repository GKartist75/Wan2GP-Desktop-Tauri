...
- [**v0.7.5**](https://github.com/GKartist75/Wan2GP-Desktop-Tauri/releases/tag/v0.7.5) *(latest)* — Guide topbar tab, Library tab, launch presets/builder, MCP helper, headless batch runner, workspace backup, config snapshots + restore, engine checks, support-bundle probes, 10-guide infographics. Details in [CHANGELOG](CHANGELOG.md).
