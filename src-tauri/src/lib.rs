...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            system::set_data_dir, system::reset_data_dir, system::migrate_to_preferred, system::move_folder, system::folder_size, system::write_wgp_config, install::install_prerequisite,
