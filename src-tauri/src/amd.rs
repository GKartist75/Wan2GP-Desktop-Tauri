...
#[cfg(test)]
mod probe_tests {
    use super::{classify_probe_failure, parse_probe_json, read_hsa_choice, write_hsa_choice, HsaChoice, COMPUTE_PROBE, KERNEL_IMPORT_PROBE, parse_kernel_json, kernel_probe_failures, is_blackwell_gpu, sage3_note};
    #[test]
